    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($conn->query($sql) === TRUE) {
                if ($temperature >= 37.5 && $temperature <= 40) {
                    //confirm popup 
                    echo "<script>alert('You are fever. Not Allowed to Join the Party.')</script>";
                } else if ($temperature >= 30 && $temperature < 37.5) {
                    echo "<script>alert('HEALTHT! Your temperature is '+'$temperature' +'℃. Are you sure to proceed?')</script>";
                }
            } else {
